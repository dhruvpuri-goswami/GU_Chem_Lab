                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add Chemical</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="add_chemical.php">
                                <div class="form-group">
                                    <label for="chem_no">Chemical No</label>
                                    <input type="text" class="form-control" id="chem_id" name="chem_id" placeholder="Ex: 12,215,2,5" required>
                                </div>
                                <div class="form-group">
                                    <label for="chem_name">Chemical Name</label>
                                    <input type="text" class="form-control" id="chem_name" placeholder="Name of the chemical" name="chem_name" required>
                                </div>
                                <div class="form-group">
                                    <label for="chem_loc">Chemical Location</label>
                                    <input type="number" class="form-control" id="chem_loc" placeholder="Location of Lab (Like 1,2,3,4)" name="chem_loc" required>
                                </div>
                                <div class="form-group">
                                    <label for="chem_quan">Chemical Quantity (in ML)</label>
                                    <input type="number" class="form-control" id="chem_quan" placeholder="Quantity of chemical (Like 15,25,12)" name="chem_quan" required>
                                </div>
